var Counter = React.createClass({
	...
	shouldComponentUpdate: function() {
    	console.log('Faza aktualizacji. Metoda ta jest wywoływana tuż PRZED wywołaniem metody render i pozwala sprawdzić, czy faktycznie trzeba jeszcze raz przerysować komponent. Zwracana jest tutaj wartość true/false. 
	Metodę tę możemy zastosować, kiedy bardzo zależy nam na optymalizacji aplikacji ')
    };
